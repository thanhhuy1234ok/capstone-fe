...
import { createUserAPI, getRolesAPI, updateUserAPI } from "@/services/api";
import { fetchSelectOptions } from "@/utils/fetchdata.list";
                    ...
                    <Col lg={6} md={6} sm={24} xs={24}>
                        ...
                        >
                            <DebounceSelect<IOptionSelect>
                                ...
                                fetchOptions={() =>
                                    fetchSelectOptions({ apiFunc: getRolesAPI })
                                }
